...
const ProductsPage = () => {
  ...
  useEffect(() => {
    async function fetchProduct() {
      const fetchedProduct: Products[] = await client.fetch(productPage);
...
//className="h-[44px] w-[44px] bg-[rgba(240,242,243,1)] rounded-lg flex items-center justify-center hover:bg-[rgba(2,159,174,1)] cursor-pointer"
